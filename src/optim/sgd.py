"""
Essentially a copy of Pytorch's SGD implementation (v2.0.0), but allowing for negative
momentum coefficients. See https://pytorch.org/docs/2.0/_modules/torch/optim/sgd.html#SGD
"""
